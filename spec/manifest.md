# Agent Manifest 协议规范 v0.2

> 版本：v0.2-draft | 状态：活跃开发中 | 上次更新：2026-06-16
...
<repo-root>/.agent/manifest.json  # 或藏在 .agent/ 目录下
```
...
| 字段 | 类型 | 说明 |
|------|------|------|
| `$schema` | string | 协议版本 URL，当前为 `https://agent-protocol.dev/v0.2/manifest.schema.json` |
...
- `v0.1` — 初始草案（已冻结）
- `v0.2` — 当前版本，新增：依赖、生命周期、链式调用、i18n、错误处理、频率限制
- `v1.0` — 稳定版本（计划中），向后兼容
